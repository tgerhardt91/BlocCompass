package com.travco.bloccompass.home;
...
public class HomeActivity extends AppCompatActivity implements OnMapReadyCallback, PermissionsListener {
    ...
    private void downloadRegionDialog() {
        ...
        final EditText regionNameEdit = new EditText(HomeActivity.this);
                ...
                .setPositiveButton(getString(R.string.positive_navigation_button_text), new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (regionName.length() == 0) {
                            Toast.makeText(HomeActivity.this, getString(R.string.map_needs_name_message), Toast.LENGTH_SHORT).show();
                        } else {
    ...
    // min/max zoom, and metadata
        ...
        map.getStyle(new Style.OnStyleLoaded() {
            ...
            public void onStyleLoaded(@NonNull Style style) {
                ...
                double minZoom = 17;
                double maxZoom = 20;
                float pixelRatio = HomeActivity.this.getResources().getDisplayMetrics().density;
                ...
                offlineManager.createOfflineRegion(definition, metadata, new OfflineManager.CreateOfflineRegionCallback() {
                    ...
                    public void onCreate(OfflineRegion offlineRegion) {
                        ...
                        HomeActivity.this.offlineRegion = offlineRegion;
                        launchDownload();
                    }
        ...
        offlineManager.listOfflineRegions(new OfflineManager.ListOfflineRegionsCallback() {
            ...
            public void onList(final OfflineRegion[] offlineRegions) {
                ...
                AlertDialog dialog = new AlertDialog.Builder(HomeActivity.this)
                        .setTitle(getString(R.string.map_select_screen_text))
                        ...
                        .setNegativeButton(getString(R.string.cancel_navigation_button_text), (dialog12, id) -> {
